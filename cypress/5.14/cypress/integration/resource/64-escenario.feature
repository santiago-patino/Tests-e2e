Feature: Escenario 64. Crear un member con email inválido aleatorio y verificar que se recibe error

    Feature Crear un member con email inválido aleatorio y verificar que se recibe error

    Scenario: Crear un member con email inválido aleatorio y verificar que se recibe error
