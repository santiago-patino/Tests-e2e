Feature: Escenario 45. Crear un member con nombre inválido pseudoaleatorio y verificar que se recibe error

    Feature Crear un member con nombre inválido pseudoaleatorio y verificar que se recibe error

    Scenario: Crear un member con nombre inválido pseudoaleatorio y verificar que se recibe error
