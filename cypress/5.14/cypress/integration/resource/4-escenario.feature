Feature: Escenario 4. Crear un member con datos de un member existente y verificar que se recibe un error
    ...
    Feature Crear un member con datos de un member existente y verificar que se recibe un error

    Scenario: Crear un member con datos de un member existente y verificar que se recibe un error
