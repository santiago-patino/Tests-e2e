Feature: Escenario 5. Eliminar un member existente y verificar que ya no aparece en la lista de members
    ...
    Feature Eliminar un member existente y verificar que ya no aparece en la lista de members

    Scenario: Eliminar un member existente y verificar que ya no aparece en la lista de members
