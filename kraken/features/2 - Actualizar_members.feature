...
@user2 @web
Scenario: Como admin creo un nuevo member con todos los datos válidos, verifico si se creó en la lista de miembros y lo elimino
    Given Ir hacia "<HOST>" "ghost"
        When Autenticarse con credenciales "<USERNAME>" "<PASSWORD>"
    Then Validar inicio sesion exitoso
    ...
    Then No debería estar el member en la lista "Edna Conde"
        And I wait for 3 seconds