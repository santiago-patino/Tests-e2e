...
Given, When('Ir hacia {kraken-string} {kraken-string}', async function (host, url) {
    return await this.driver.url(host+url);
});

When('Autenticarse con credenciales {kraken-string} {kraken-string}', async function (user, pass) {
