...
Scenario: Crear una page con todos sus datos, publicar y visualizar 
    ...
    When I create a page with title "$name_1" and content "$string_1"
        And I wait for 2 seconds
    Then validate created or edit page with title "$$name_1"
        And I wait for 1 seconds
   
    Given select page from list with title "$$name_1"
        And I wait for 2 seconds
...
Scenario: Crear y editar una page con todos sus datos, actualizar y visualizar
    ...
    Given I go to page
        And I go to new page form
    When I create a page with title "$name_2" and content "$string_1"
        And I wait for 2 seconds
    Then validate created or edit page with title "$$name_2"
        And I wait for 1 seconds
        
    Given select page from list with title "$$name_2"
        And I wait for 2 seconds
    ...
    When I go to page
        ...
        And I go to edit page with a title "$name_3"
        And I wait for 1 seconds
        And I update page
...
Scenario: Crear, eliminar page y validar que no se encuentre page
    ...
    Given I go to page
        And I go to new page form
    When I create a page with title "$name_4" and content "$string_1"
        And I wait for 3 seconds
...
Scenario: Crear page draft con todos sus datos e intentar visualizar 
    ...
    Given I go to page
        And I go to new page form
    When I create a page with title "$name_5" and content "$string_1"
        And I wait for 2 seconds
    Then validate created or edit page with title "$$name_5"
         And I wait for 1 seconds

    Given I go to page url with title "$name_5"
        And I wait for 1 seconds
...
Scenario: Crear page, configurar nav y validar que sea accesible 
    ...
    Given I go to page
        And I go to new page form
    When I create a page with title "$name_6" and content "$string_1"
        And I wait for 2 seconds
    Then validate created or edit page with title "$$name_6"
        And I wait for 1 seconds

    Given select page from list with title "$$name_6"
        And I wait for 2 seconds
